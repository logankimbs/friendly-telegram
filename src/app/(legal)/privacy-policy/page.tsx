        ...
        <div className="relative px-4 pb-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[40rem]">
            ...
            <p className="mb-4 text-sm text-slate-700">
              ...
              to any other purposes described in the present document. The owner
              does not share any data collected with third-parties. Text
              messaging opt-in data and consent are not shared with any third
              parties (including subsidiaries and affiliates).
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              activity, as well as the following: Registration and
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              by Google LLC and is connected to the Google network. The service
              processes various types of personal data, as specified in its{' '}
              <a
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              necessary for the performance of an agreement with the User and/or
              for any pre-contractual obligations; processing is required for
              compliance with a legal obligation to which the Owner is subject;
              it is related to a task carried out in the public interest or in
              the exercise of official authority vested in the Owner; or it is
              necessary for the purposes of the legitimate interests pursued by
              the Owner or a third party. In any case, the Owner is available to
              clarify the specific legal basis applicable to the processing,
              including whether the provision of Personal Data is a statutory or
              contractual requirement or a necessity for entering into a
              contract.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              by the Owner, to the extent permitted by law. They have the right
              to withdraw their consent at any time if they have previously
              given consent to the processing of their Personal Data. Users may
              also object to the processing of their Data if it is being
              processed on a legal basis other than consent. Additionally, they
              have the right to access their Data, learn if it is being
              processed, obtain disclosure regarding certain aspects of the
              processing, and receive a copy of the Data undergoing processing.
            </p>

            <p className="mt-4 text-sm text-slate-700">
              Users may verify the accuracy of their Data and request that it be
              updated or corrected. They also have the right to restrict the
              processing of their Data, in which case the Owner will store the
              Data but will not process it for any other purpose. Furthermore,
              Users may request the deletion or removal of their Personal Data.
              They also have the right to receive their Data in a structured,
              commonly used, and machine-readable format and, if technically
              feasible, to have it transferred to another controller without any
              hindrance.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              past 12 months, enabling you to make informed decisions about how
              your data is used. While these categories are primarily based on
              California privacy laws, they also offer insight into the types of
              Personal Information collected for individuals outside of
              California.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              service’s privacy policy. This data is processed for purposes such
              as registration and authentication and is retained for the
              duration necessary to fulfill its intended purpose. The collected
              data may be sold or shared but is not used for targeted
              advertising. The third party involved in this processing is Google
              LLC.
            </p>

            <p className="mt-4 text-sm text-slate-700">
              Definitions of relevant terms can be found in the “Definitions and
              Legal References” section of this Privacy Policy. For more
              ...
              Under US State Laws” section. Additional details on the collection
              and processing of Personal Information are available in the
              “Detailed Information on the Processing of Personal Data” section.
            </p>

            <p className="mt-4 text-sm text-slate-700">
              The Owner does not process Personal Information for purposes that
              are unexpected, unnecessary, or incompatible with the originally
              disclosed purposes without obtaining consent.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              who are residents in the following states: California, Virginia,
              Colorado, Connecticut, Utah, Texas, Oregon and Montana. For such
              Users, this information supersedes any other possibly divergent or
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              Information, subject to applicable law. Specifically, you have the
              right to access your Personal Information, also known as the right
              to know. This allows you to request confirmation of whether we are
              processing your Personal Information and to access such data. You
              also have the right to correct inaccurate Personal Information by
              requesting that we update or amend any inaccuracies in the data we
              maintain about you.
            </p>

            <p className="mt-4 text-sm text-slate-700">
              Additionally, you have the right to request the deletion of your
              Personal Information, allowing you to ask for its removal from our
              records. If applicable, you may also obtain a copy of your
              Personal Information in a portable and usable format, facilitating
              its transfer to another entity, provided that such a transfer is
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              exercising your privacy rights. Furthermore, you have the right to
              non-discrimination, ensuring that the exercise of your privacy
              rights does not result in any unfair treatment.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              to only that which is necessary to perform the services or provide
              the goods, as is reasonably expected by an average consumer.
              Please note that certain exceptions outlined in the law may apply,
              such as, when the collection and processing of Sensitive Personal
              Information is necessary to verify or maintain the quality or
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              United States, as a User residing in Virginia, Colorado,
              Connecticut, Texas and Oregon, you have The right to opt out of
              the processing of your personal information for Targeted
              Advertising or profiling in furtherance of decisions that produce
              legal or similarly significant effects concerning you; The right
              to freely give, deny or withdraw your consent for the processing
              of your Sensitive Personal Information. Please note that certain
              exceptions outlined in the law may apply, such as, but not limited
              to, when the collection and processing of Sensitive Personal
              Information is necessary for the provision of a product or service
              specifically requested by the consumer.
            </p>

            <p className="mt-4 text-sm text-slate-700">
              <strong>Rights for users residing in Utah.</strong> In addition to
              the rights listed above common to all Users in the United States,
              as a User residing in Utah, you have The right to opt out of the
              processing of your Personal Information for Targeted Advertising;
              The right to opt out of the processing of your Sensitive Personal
              Information. Please note that certain exceptions outlined in the
              law may apply, such as, but not limited to, when the collection
              and processing of Sensitive Personal Information is necessary for
              the provision of a product or service specifically requested by
              the consumer.
            </p>
            ...
            <p className="mt-4 text-sm text-slate-700">
              ...
              Information collected from you in connection with the verification
              of your request solely for verification and shall not further
              disclose the Personal Information, retain it longer than necessary
              for purposes of verification, or use it for unrelated purposes. If
              you are an adult, you can make a request on behalf of a child
